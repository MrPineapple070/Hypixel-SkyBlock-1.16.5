![5db20c336c34f.skyblock%200.7.3.png](https://staticassets.hypixel.net/news/5db20c336c34f.skyblock%200.7.3.png "0.7.0 Update")
...
<details>
<summary>The Calendar in your SkyBlock Menu has all event schedules!</summary>
<img src="https://staticassets.hypixel.net/news/5db1bb18e82e8.download-2.png" alt="Calendar"><br>
<img src="https://staticassets.hypixel.net/news/5db1bb2062934.download-1.png" alt="Spooky Festival"><br>
</details>
...
The **Fear Mongerer** is a new NPC that appears for 3 hours (1 hour before and after the event) and is located in the Village, where the Baker usually stands.  
...
![5db1c0c0cdbce.download-3.png](https://staticassets.hypixel.net/news/5db1c0c0cdbce.download-3.png)

## New Spooky Achievements  

-   Participate in killing a Headless Horseman - 5 points
-   Find a Purple Candy - 5 points
-   Kill a Bat Pi&#x00f1;ata - 5 points

# &#x25B6; New Pumpkin Collection Items  
The Pumpkin Collection now has 2 new items  
  
## **Training Dummy**: _Unlocked in Pumpkin Collection V_  
...
## **Farming Boots**: _Unlocked in Pumpkin Collection IX_  
Similar to the Lantern Helmet, those boots scale with your Farming Level, the higher it is, the more speed they give you. Useful when farming!  
  
# &#x25B6; Spooky Village  
![5db1c337902ea.2019-10-24_17.27.32.png](https://staticassets.hypixel.net/news/5db1c337902ea.2019-10-24_17.27.32.png "Spooky Festival Decorations")  
_The Villagers decided to decorate their houses during the Spooky Festival_  
...
![5db20ba913097.download-4.png](https://staticassets.hypixel.net/news/5db20ba913097.download-4.png "Drinks anyone?")
...
-   "[Sky of Trees](https://www.youtube.com/watch?v=x3bBQasjbfs&feature=youtu.be)" will now play on Foraging islands
-   "[Abstract Ringing](https://youtu.be/IMMV6JJjHZo)" will now play in the Wilderness
-   "[Hallow Hallow](https://www.youtube.com/watch?v=Dsjic_fnrZw)" is the theme of the Spooky Event

# &#x25B6; General Changes  
-   Enchanted items can no longer be used to craft vanilla recipes
-   Watchers are now correctly dropping arrows
-   Intimidation Talisman now works with Spiders and Blazes

If you missed the last bug patches, you can find them in the  [SkyBlock patch notes section](https://hypixel.net/forums/skyblock-patch-notes.158/).  

## A note on future content

<details>
<summary>Click to Read</summary>
The next patch will be 0.7.4, there are still a few features that are close to being released, it'll be a smaller patch and you can expect 0.7.4 to be released within 1 to 2 weeks.  
...
Of course, we have many many more plans for SkyBlock, but we will talk about those in a later thread.
</details>
We hope you enjoy this new content, thanks for playing!  
  
[@Relenter](https://hypixel.net/members/57026/) - Zealot Changes + Spooky Event  
[@Minikloon](https://hypixel.net/members/287602/) - Bartender + Spooky Event  
[@aPunch](https://hypixel.net/members/45616/) - Spooky Event + Pumpkin Collection items  
[@erosemberg](https://hypixel.net/members/37978/) - Colosseum Changes  
[@Sylent](https://hypixel.net/members/46485/), HPC and Bugs Team - Testing/QA  
[@ShinkoNet](https://hypixel.net/members/43531/) - New SkyBlock Musics  
