...
![5d9ff5758dd99.skyblock%200.7.2.png](https://staticassets.hypixel.net/news/5d9ff5758dd99.skyblock%200.7.2.png)
...
# &#x25B6;  Slayer Quests  
![5da017600d91e.horror.png](https://staticassets.hypixel.net/news/5da017600d91e.horror.png "Revenant Horror")  
...
<center>Find Maddox in the basement of the Tavern in the SkyBlock Hub to do Slayer Quests.​</center>

Maddox is a new NPC who lives under the tavern. His quests are fairly simple: Kill X number of monsters, then slay the boss.  
![5da018ceee515.revenant.png](https://staticassets.hypixel.net/news/5da018ceee515.revenant.png "Revenant Horror III")
...
![5da01de212821.rev_chestplate.png](https://staticassets.hypixel.net/news/5da01de212821.rev_chestplate.png "Revenant Chestplate")
...
![5da01d5ad3424.rev_minion.png](https://staticassets.hypixel.net/news/5da01d5ad3424.rev_minion.png "Revenant Minion")
# &#x25B6;  Minion Balance  
...
![5d9fae18da40e.download.png](https://staticassets.hypixel.net/news/5d9fae18da40e.download.png "Deluxe Account")

<div class="bbCodeSpoiler">
<button type="button" class="bbCodeSpoiler-button button--longText button is-active" data-xf-click="toggle" data-xf-init="tooltip" data-original-title="Click to reveal or hide spoiler" id="js-XFUniqueId3"><span class="button-text">
<span><span class="bbCodeSpoiler-button-title">Click to view all upgrades</span></span>
</span></button>
<div class="bbCodeSpoiler-content is-active" tabindex="-1" style="">
<div class="bbCodeBlock bbCodeBlock--spoiler">
<div class="bbCodeBlock-content"><b>Upgrade 1: Gold Account</b> (Requires 100k Gold Collection)<br>
Costs: 5 million coins + 1 Enchanted Gold Block<br>
Increases the Bank cap from 50 millions to 100 millions<br>
Also increase the interest cap from 15 millions to 20 millions (total of 300k interests maximum)<br>
<br>
<b>Upgrade 2: Deluxe Account</b> (Requires 250k Gold Collection)<br>
Costs: 10 million coins + 5 Enchanted Gold Blocks<br>
Increases the Bank cap from 100 millions to 250 millions<br>
Also increase the interest cap from 20 millions to 30 millions (total of 350k interests maximum)<br>
<br>
<b>Upgrade 3: Super Deluxe Account</b> (Requires 500k Gold Collection)<br>
Costs: 25 million coins + 20 Enchanted Gold Blocks<br>
Increases the Bank cap from 250 millions to 500 millions<br>
Also increase the interest cap from 30 millions to 50 millions (total of 390k interests maximum)<br>
<br>
<b>Upgrade 4: Premier Account</b> (Requires 1M Gold Collection)<br>
Costs: 50 million coins + 50 Enchanted Gold Blocks<br>
Increases the Bank cap from 500 millions to 1,000 millions<br>
Also increase the interest cap from 50 millions to 160 millions (total of 500k interests maximum)</div>
</div>
</div>
</div>
...
# &#x25B6;  SkyBlock API  
We recently released the  [SkyBlock API](https://github.com/HypixelDev/PublicAPI/tree/master/Documentation/methods/skyblock), which will allow content creators to make very useful websites.  
...
The next SkyBlock patch will be 0.7.3 and will feature more content, unrelated to Dungeons, and is expected to release within 2 to 3 weeks.  
  
As always, thank you for playing SkyBlock on Hypixel!  
  
[@Relenter](https://hypixel.net/members/57026/)  - Minion Balancing  
[@Minikloon](https://hypixel.net/members/287602/)  - The Slayer content + Bank Upgrades  
[@ConnorLinfoot](https://hypixel.net/members/14325/)  - API  
[@Sylent](https://hypixel.net/members/46485/), HPC and Bugs Team - Testing/QA  
Also a huge welcome to  [@sfarnham](https://hypixel.net/members/94998/)  who is a new Game Designer. He will be working with  [@Jayavarmen](https://hypixel.net/members/30478/)  on SkyBlock (and the rest of the network).  
