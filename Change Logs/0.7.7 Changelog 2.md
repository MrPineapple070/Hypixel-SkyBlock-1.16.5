...
Following the Bazaar update: [https://hypixel.net/threads/skyblock-patch-0-7-7-bazaar.2655146/](https://hypixel.net/threads/skyblock-patch-0-7-7-bazaar.2655146/)  
  
Bazaar related:  
-   [Added API support](https://github.com/HypixelDev/PublicAPI/tree/master/Documentation/methods/skyblock/bazaar)
...
Products added: (shoutout to [Burritoos](https://hypixel.net/threads/missing-items-for-sale-in-bazaar.2658278/))  
