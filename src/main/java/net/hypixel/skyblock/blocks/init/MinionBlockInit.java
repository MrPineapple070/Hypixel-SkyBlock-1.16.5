...
import net.hypixel.skyblock.blocks.minion.TempMinion;
...
public class MinionBlockInit {
	...
	public static final RegistryObject<AcaciaMinion> acacia_minion_1 = minionBlocks.register("acacia_minion_1",
			() -> new AcaciaMinion(MinionTier.I));
	public static final RegistryObject<AcaciaMinion> acacia_minion_2 = minionBlocks.register("acacia_minion_2",
			() -> new AcaciaMinion(MinionTier.II));
	public static final RegistryObject<AcaciaMinion> acacia_minion_3 = minionBlocks.register("acacia_minion_3",
			() -> new AcaciaMinion(MinionTier.III));
	public static final RegistryObject<AcaciaMinion> acacia_minion_4 = minionBlocks.register("acacia_minion_4",
			() -> new AcaciaMinion(MinionTier.IV));
	public static final RegistryObject<AcaciaMinion> acacia_minion_5 = minionBlocks.register("acacia_minion_5",
			() -> new AcaciaMinion(MinionTier.V));
	public static final RegistryObject<AcaciaMinion> acacia_minion_6 = minionBlocks.register("acacia_minion_6",
			() -> new AcaciaMinion(MinionTier.VI));
	public static final RegistryObject<AcaciaMinion> acacia_minion_7 = minionBlocks.register("acacia_minion_7",
			() -> new AcaciaMinion(MinionTier.VII));
	public static final RegistryObject<AcaciaMinion> acacia_minion_8 = minionBlocks.register("acacia_minion_8",
			() -> new AcaciaMinion(MinionTier.VIII));
	public static final RegistryObject<AcaciaMinion> acacia_minion_9 = minionBlocks.register("acacia_minion_9",
			() -> new AcaciaMinion(MinionTier.IX));
	public static final RegistryObject<AcaciaMinion> acacia_minion_a = minionBlocks.register("acacia_minion_a",
			() -> new AcaciaMinion(MinionTier.X));
	public static final RegistryObject<AcaciaMinion> acacia_minion_b = minionBlocks.register("acacia_minion_b",
