...
public class EnderBow extends ModBowItem {
	private static final List<ITextComponent> tooltip = Arrays.asList(
			item_ability.copy().append(new TranslationTextComponent("bow.ender.ability"))
					.withStyle(TextFormatting.GOLD),
			new TranslationTextComponent("bow.ender.ability.0", Items.ENDER_PEARL.getName(ItemStack.EMPTY)),
			new TranslationTextComponent("bow.ender.ability.1", StatString.health));
