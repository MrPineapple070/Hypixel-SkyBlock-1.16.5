...
public class TarantulaBoots extends ModArmorItem {
	...
	static {
		try {
			...
			discription.add(new StringTextComponent("Item Ability: Double Jump").withStyle(TextFormatting.GOLD));
			discription.add(new StringTextComponent("Allows you to Double Jump."));
			discription.add(new StringTextComponent("Piece Bonus: Spider Bulwark").withStyle(TextFormatting.GOLD));
