...
public class ItemInit {
	...
	public static final RegistryObject<Item> auto_smelter = items.register("auto_smelter",
			() -> new UpgradeItem(ItemProperties.mine_64));
	...
	public static final RegistryObject<Item> catalyst = items.register("catalyst",
			() -> new EnchantedFuelItem(ItemProperties.mine_64, 216000, 1 / 3d));
	...
	public static final RegistryObject<Item> desert_biome_stick = items.register("desert_biome_stick",
			() -> new EnchantedItem(ItemProperties.mine_1));
	...
	public static final RegistryObject<Item> enchanted_lava_bucket = items.register("enchanted_lava_bucket",
			() -> new EnchantedFuelItem(ItemProperties.mine_64, -1, .75));
	...
	public static final RegistryObject<Item> flint_shovel = items.register("flint_shovel",
			() -> new ShovelItem(ItemTier.DIAMOND, 0, Float.MAX_VALUE, ItemProperties.mine_1));
	public static final RegistryObject<Item> flycatcher = items.register("flycatcher",
			() -> new UpgradeItem(ItemProperties.combat_64));
	public static final RegistryObject<Item> foul_flesh = items.register("foul_flesh",
			() -> new MinionFuelItem(ItemProperties.combat_64, 0x57e40, .9));
	public static final RegistryObject<Item> grand_xp_bottle = items.register("grand_xp_bottle",
			() -> new ModExperienceBottleItem(ItemProperties.mine_64, Type.GRAND));
	public static final RegistryObject<Item> hamster_wheel = items.register("hamster_wheel",
			() -> new MinionFuelItem(ItemProperties.combat_64, 0x1a5e00, .5));
	public static final RegistryObject<Item> hyper_catalyst = items.register("hyper_catalyst",
			() -> new MinionFuelItem(ItemProperties.mine_1, 0x69780, 3));
	...
	public static final RegistryObject<Item> plasma_bucket = items.register("plasma_bucket",
			() -> new MinionFuelItem(ItemProperties.mine_1, -1, .35));
	...
	public static final RegistryObject<Item> titanic_xp_bottle = items.register("titanic_xp_bottle",
			() -> new ModExperienceBottleItem(ItemProperties.mine_64, Type.TITANIC));
