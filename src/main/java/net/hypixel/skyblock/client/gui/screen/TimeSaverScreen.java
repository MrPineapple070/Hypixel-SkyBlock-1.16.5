...
public class TimeSaverScreen extends ContainerScreen<TimeSaverContainer> {
	...
	abstract static class Button extends AbstractButton {
		...
		public void renderButton(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
			Minecraft.getInstance().getTextureManager().bind(TimeSaverScreen.background_texture);
	...
	class CancelButton extends SpriteButton {
		private final StringTextComponent tooltip = new StringTextComponent(I18n.get("gui.cancel"));
		...
		public void onPress() {
			TimeSaverScreen.this.minecraft.player.connection
					.send(new CCloseWindowPacket(TimeSaverScreen.this.minecraft.player.containerMenu.containerId));
			TimeSaverScreen.this.minecraft.forceSetScreen((Screen) null);
		}
	...
	class ConfirmButton extends SpriteButton {
		private final StringTextComponent tooltip = new StringTextComponent(I18n.get("gui.done"));
	...
	class PowerButton extends Button {
		...
		protected void bindTexture(MatrixStack stack) {
			Minecraft.getInstance().getTextureManager().bind(this.texture_sprite.atlas().location());
		...
		@Override
		public void renderToolTip(MatrixStack stack, int x, int y) {
			TimeSaverScreen.this.renderTooltip(stack, new StringTextComponent(String.valueOf(this.time)), x, y);
		}
	}
